        ...
        <div>
            <div className='py-[10px] px-[30px] flex items-center justify-between'>
                ...
                <div className='flex items-center justify-end gap-[10px]'>
                    <button>
                        <svg className='w-[2.6rem]' xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" ><path d="m22 2-7 20-4-9-9-4Z" /><path d="M22 2 11 13" /></svg>
                    </button>
